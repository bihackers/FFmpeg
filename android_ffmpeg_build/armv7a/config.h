...
#define FFMPEG_CONFIGURATION "--prefix=android_ffmpeg_build/armv7a --disable-shared --enable-static --disable-ffserver --enable-cross-compile --cross-prefix=/Users/chenhangfeng/Desktop/android-ndk-r10e/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --target-os=linux --arch=arm --sysroot=/Users/chenhangfeng/Desktop/android-ndk-r10e/platforms/android-9/arch-arm/ --extra-cflags='-Os -fpic -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb -mfpu=neon -mfloat-abi=softfp' --extra-ldflags='-Wl,--fix-cortex-a8' --enable-gpl --enable-postproc --enable-nonfree --disable-everything --enable-debug --disable-programs --disable-asm --enable-neon --enable-doc --enable-pic --enable-memalign-hack --enable-small --enable-decoder=h264 --enable-encoder=aac --enable-decoder=pcm_mulaw --disable-demuxers --disable-parsers --disable-protocols --enable-demuxer=h264 --enable-demuxer=rtsp --enable-protocol=tcp --enable-protocol=udp --enable-protocol=hls --enable-protocol=rtmp --enable-protocol=http --enable-decoder=aac --enable-parser=aac --enable-parser=hevc --enable-decoder=hevc --enable-demuxer=hls --enable-demuxer=hevc --enable-parser=h264 --enable-network --enable-mediacodec --enable-jni --enable-decoder=h264_mediacodec"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "android_ffmpeg_build/armv7a/share/ffmpeg"
#define AVCONV_DATADIR "android_ffmpeg_build/armv7a/share/ffmpeg"
