...
#define FFMPEG_CONFIGURATION "--prefix=android_ffmpeg_build/armeabi --disable-shared --enable-static --enable-ffserver --enable-cross-compile --cross-prefix=/Users/chenhangfeng/Desktop/android-ndk-r10e/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --target-os=linux --arch=arm --sysroot=/Users/chenhangfeng/Desktop/android-ndk-r10e/platforms/android-9/arch-arm/ --extra-cflags='-Os -fpic -marm -O3 -Wall -mthumb -pipe -fpic -fasm -finline-limit=300 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -fmodulo-sched -fmodulo-sched-allow-regmoves -Wno-psabi -Wa,--noexecstack -D__ARM_ARCH_5__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5TE__ -DANDROID -DNDEBUG -mfpu=neon -mfloat-abi=softfp' --extra-ldflags= --enable-nonfree --disable-everything --enable-gpl --enable-postproc --enable-debug --disable-programs --disable-asm --enable-neon --enable-doc --enable-pic --enable-memalign-hack --enable-small --enable-decoder=h264 --enable-encoder=aac --enable-decoder=pcm_mulaw --disable-demuxers --disable-parsers --disable-protocols --enable-demuxer=h264 --enable-demuxer=rtsp --enable-protocol=tcp --enable-protocol=udp --enable-protocol=hls --enable-protocol=rtmp --enable-protocol=http --enable-decoder=aac --enable-parser=aac --enable-parser=hevc --enable-decoder=hevc --enable-demuxer=hls --enable-demuxer=hevc --enable-parser=h264 --enable-network --enable-mediacodec --enable-jni --enable-decoder=h264_mediacodec"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "android_ffmpeg_build/armeabi/share/ffmpeg"
#define AVCONV_DATADIR "android_ffmpeg_build/armeabi/share/ffmpeg"
