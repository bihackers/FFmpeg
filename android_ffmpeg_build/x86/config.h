...
#define FFMPEG_CONFIGURATION "--prefix=android_ffmpeg_build/x86 --disable-shared --enable-static --disable-ffserver --enable-cross-compile --cross-prefix=/Users/chenhangfeng/Desktop/android-ndk-r10e/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android- --target-os=linux --arch=x86 --sysroot=/Users/chenhangfeng/Desktop/android-ndk-r10e/platforms/android-9/arch-x86/ --extra-cflags='-Os -fpic -march=atom -msse3 -ffast-math -mfpmath=sse' --extra-ldflags= --enable-nonfree --disable-everything --enable-gpl --enable-postproc --enable-debug --disable-programs --disable-asm --enable-neon --enable-doc --enable-pic --enable-memalign-hack --enable-small --enable-decoder=h264 --enable-encoder=aac --enable-decoder=pcm_mulaw --disable-demuxers --disable-parsers --disable-protocols --enable-demuxer=h264 --enable-demuxer=rtsp --enable-protocol=tcp --enable-protocol=udp --enable-protocol=hls --enable-protocol=rtmp --enable-protocol=http --enable-decoder=aac --enable-parser=aac --enable-parser=hevc --enable-decoder=hevc --enable-demuxer=hls --enable-demuxer=hevc --enable-parser=h264 --enable-yasm --enable-network"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "android_ffmpeg_build/x86/share/ffmpeg"
#define AVCONV_DATADIR "android_ffmpeg_build/x86/share/ffmpeg"
