...
#define FFMPEG_CONFIGURATION "--prefix=android_ffmpeg_build/arm64 --disable-shared --enable-static --disable-ffserver --enable-cross-compile --cross-prefix=/Users/chenhangfeng/Desktop/android-ndk-r10e/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/bin/aarch64-linux-android- --target-os=linux --arch=aarch64 --sysroot=/Users/chenhangfeng/Desktop/android-ndk-r10e/platforms/android-21/arch-arm64/ --extra-cflags='-Os -fpic ' --extra-ldflags= --enable-nonfree --disable-everything --enable-gpl --enable-postproc --enable-debug --disable-programs --disable-asm --enable-neon --enable-doc --enable-pic --enable-memalign-hack --enable-small --enable-decoder=h264 --enable-encoder=aac --enable-decoder=pcm_mulaw --disable-demuxers --disable-parsers --disable-protocols --enable-demuxer=h264 --enable-demuxer=rtsp --enable-protocol=tcp --enable-protocol=udp --enable-protocol=hls --enable-protocol=rtmp --enable-protocol=http --enable-decoder=aac --enable-parser=aac --enable-parser=hevc --enable-decoder=hevc --enable-demuxer=hls --enable-demuxer=hevc --enable-parser=h264 --enable-yasm --enable-network --enable-mediacodec --enable-jni --enable-decoder=h264_mediacodec"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "android_ffmpeg_build/arm64/share/ffmpeg"
#define AVCONV_DATADIR "android_ffmpeg_build/arm64/share/ffmpeg"
